...
def create_table_values(years, principal, monthly_payment, rate):
    ...
    for year in range(1, years+1):
        for month in range(1, 12+1):
            ...
            table_values.append([tabl_payment_no, tabl_interest, tabl_principal, tabl_left_to_pay])
    return table_values

def print_table(table_values):
    """Se seznamem hodnot vytiskněte tabulku hypotéky
     """
    print(tabulate(table_values, headers=['Payment', 'Interest', 'Principal', 'Left to Pay'], tablefmt='outline'))
